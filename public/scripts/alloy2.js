...
*/
        ...
        var createRequestPayload = (function (construct) {
            ...
            return reactorObjectAssign({}, basePayload, extendedPayload);
        });
...
*/
        ...
        var getScopes = function getScopes(decisionScopes) {
        ...
        var getViewName = function getViewName(xdm) {
            if (!xdm) {
                return undefined;
            }
            ...
            var webPageDetails = web.webPageDetails;
        ...
        var createPersonalizationDetails = (function (_ref) {
            ...
            var xdm = event.toJSON().xdm;
            var viewName = getViewName(xdm);
            return {
                isRenderDecisions: function isRenderDecisions() {
                    return renderDecisions;
                },
                getDecisionScopes: function getDecisionScopes() {
                ...
                createQueryDetails: function createQueryDetails() {
                    var schemas = [HTML_CONTENT_ITEM, JSON_CONTENT_ITEM, REDIRECT_ITEM, DOM_ACTION];
                    return {
                        schemas: schemas,
                ...
                shouldFetchData: function shouldFetchData() {
                    return this.hasScopes() || !this.isCacheInitialized() || !this.hasViewName() && this.isRenderDecisions();
                },
...
*/
        ...
        var createComponent$3 = (function (_ref) {
            ...
            var consentByPurpose = reactorObjectAssign(_defineProperty({}, GENERAL, defaultConsent), readStoredConsent());
...
*/
        ...
        var _window = window,
            console$1 = _window.console; // set this up as a function so that monitors can be added at anytime
